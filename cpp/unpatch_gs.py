...
# Remove Virtual Gamepad from BuildHUD
vpad_code = """
...
"""
content = content.replace(vpad_code, '\n}')
...
"""
content = content.replace(resize_code, '\n    }\n')
...
"""
content = content.replace(update_code, 'void GameScreen::Update(float dt) {\n    hud_overlay_->Update(dt);\n    window_manager_->Update(dt);\n}\n')
