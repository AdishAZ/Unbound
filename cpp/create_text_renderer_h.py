...
'''
    with open('d:/Unbound/pokemon/cpp/include/ui/text_renderer.h', 'w', encoding='utf-8') as f:
        f.write(content)

create_text_renderer_h()
print("text_renderer.h created")
